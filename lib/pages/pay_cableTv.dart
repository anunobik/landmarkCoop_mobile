...
Future<Object?> payCableTv(
  BuildContext context, {
  required ValueChanged onClosed,
  required String fullName,
  required String token,
  required List<BillsInfoResponseModel> cableTvList,
  ...
  return showGeneralDialog(
    ...
    barrierLabel: 'Cable Tv Subscription',
                      ...
                      child: Column(
                        children: [
                          ...
                          DropdownButtonFormField<BillsInfoResponseModel>(
                            ...
                            hint: Text('Select Cable TV'),
                            items: cableTvList
                                .map((BillsInfoResponseModel cableTv) {
                                ...
                                try {
                                  flutterWaveService
                                      .validateFlutterwaveBill(
                                          ...
                                          smartCardController.text.trim(), token)
                                      .then((value) {
                                  ...
                                  setState(() {
                                    validated = true;
                                    cardName =
                                        'Ensure card no. is entered and/or cable type is selected';
                                  });
                                }
                              },
                              child: Text(
                                'Click to validate Card No.',
                                style: GoogleFonts.montserrat(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 16,
                                ),
                          ...
                          isApiCallProcess
                              ...
                              : ElevatedButton(
                                  onPressed: () async {
                                    ...
                                    txRef =
                                        "${smartCardController.text.trim()}_$datePart";
                                    InstantAirtimeAndDataRequestModel
                                        instantAirtimeAndDataRequestModel =
                                        InstantAirtimeAndDataRequestModel(
                                      phoneNumber: smartCardController.text,
                                      amount: selectedCableTv!.amount,
                                      requestType: "Cable TV",
...
void rechargeCableTv(
  ...
  apiFlutterWave.buyDataBundle(dataBundleRequestModel, selectedCableTv.billerCode, selectedCableTv.itemCode, token).then((value) {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text('Incomplete Transaction'),
          );
        },
      );
    }
