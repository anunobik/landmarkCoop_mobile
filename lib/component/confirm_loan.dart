...
//   final amount;
//
//   ConfirmLoan({required this.token,
//     required this.accountNumber,
//     required this.amount,});
//   @override
//   _ConfirmLoanState createState() => _ConfirmLoanState(token, accountNumber, amount);
// }
//
...
//             Center(
//               child: Text(
//                 'Your Loan NGN' + displayAmount.format(double.parse(amount)) +' is been preocessed',
