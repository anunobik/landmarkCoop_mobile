...
//   final amount;
//
//   const ConfirmDeposit({required this.token,
//     required this.accountNumber,
//     required this.amount,});
//
//   @override
//   ConfirmDepositState createState() => ConfirmDepositState(token, accountNumber, amount);
// }
//
// class ConfirmDepositState extends State<ConfirmDeposit> {
//    ConfirmDepositState(
...
//               child: Center(
//                 child: Text(
//                   'Your account is credited with NGN' + displayAmount.format(double.parse(amount)),
//                   textAlign: TextAlign.center,
//                   style: GoogleFonts.montserrat(
